...
WebUI.setText(findTestObject('Object Repository/Page_Element/input_Or_mx_RegistrationForm_username'), 'testnumber1')

WebUI.click(findTestObject('Object Repository/Page_Element/div_English (US)Create accountHost account _beea4a'))

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Element/input_Username_mx_RegistrationForm_password'), 'uioLPrA0vscFhNVhazWQkQ==')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Element/input_Password_mx_RegistrationForm_passwordConfirm'), 
    'uioLPrA0vscFhNVhazWQkQ==')

WebUI.click(findTestObject('Object Repository/Page_Element/div_Create accountHost account onmatrix.org_6b4dd0'))

WebUI.setText(findTestObject('Object Repository/Page_Element/input_Confirm password_mx_Field_1'), 'thanhvu20210811@gmail.com')
